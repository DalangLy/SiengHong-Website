            ...
            <div id="header_search_and_language_container">
                <div id="desktop_header_language_switcher_container">
                    ...
                    <p style="padding: 0; margin: 0; font-size: 20px; color: white">
                        <a href="{{route('house', 'en')}}" @if(request()->segment(1) == 'en') class="language_active" @endif class="text-white mx-1" style="text-decoration: none">EN</a>|<a href="{{route('house', 'kh')}}" @if(request()->segment(1) == 'kh') class="language_active" @endif class="text-white mx-1" style="text-decoration: none">KH</a>
                    </p>
                </div>
