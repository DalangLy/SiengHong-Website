<div id="land_page_mobile_side_nav_overlay">
</div>
        ...
        <div class="w-100 h-100 d-flex flex-column">
            ...
            <div style="height: auto; width: 100%;">{{--mobile language switch--}}
                <div class="h-100 w-100 px-3 d-flex flex-column">
                    <a id="mobile_home_language_kh" href="{{route('land', 'kh')}}" style="display: none"></a>
                    ...
                    <a id="mobile_home_language_en" href="{{route('land', 'en')}}" style="display: none"></a>
