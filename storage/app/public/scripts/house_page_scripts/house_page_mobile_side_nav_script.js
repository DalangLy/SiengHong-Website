...
let mobileSideNavOverlay = document.getElementById('house_page_mobile_side_nav_overlay');
...
document.getElementById('mobile_side_nav_close_btn').addEventListener('click', function (){
    openMobileSideNav();
}, false);
